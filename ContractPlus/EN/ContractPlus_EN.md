...
![Image Added value through the ContractPlus app](image/ctpAbb1.png) Fig.1 Added value through the ContractPlus app 
...
![Image Installation and Configuration Process](image/D365BC-KTC-APP_Installation_EN.png) Fig.2 Installation and Configuration Process

### Permissions to install an extension

The company administrator must grant you the following permissions in Business Central to install a KTC extension in your environment: D365 EXTENSION MGT or EXT MGT. - ADMIN.

![Image MS D365 BC - Permissions](image/ctpAbb2.png) Fig.2 MS D365 BC - Permissions
...
![Image Microsoft Marketplace for Extensions (AppSource)](image/ctpAbb3.png) Fig.3 Microsoft Marketplace for Extensions (AppSource).

In the Marketplace search, type ContractPlus and select the app shown below.

![Image Marketplace ContractPlus](image/ctpAbb4.png) Fig.4 Marketplace ContractPlus
...
![Image ContractPlus directly in MS AppSource, call via browser](image/ctpAbb5.png) Fig.5 ContractPlus directly in MS AppSource, call via browser.
...
![Image Dynamics 365 Business Central - Selecting the environment](image/ctpAbb6.png) Fig.6 Dynamics 365 Business Central - Selecting the environment.
...
![Image Extension installation: Language selection and installation](image/ctpAbb7.png) Fig.7 Extension installation: Language selection and installation
...
![Image : Checking the installation status](image/ctpAbb8.png) Fig.8 Checking the installation status

An extension is completely installed and ready for use when the status is completed.

![Image : Installation status: completed](image/ctpAbb9.png) Fig.9 Installation status: completed 
...
![Image : Opening the KTC License Management App](image/ctpAbb10.png) Fig.10 Opening the KTC License Management App
...
![Image:Calling up the license management](image/ctpAbb11.png) Fig.11 Calling up the license management
...
![Image : : Setting up the KTC License Management Extension](image/ctpAbb12.png) Fig.12 Setting up the KTC License Management Extension
...
![Image : The KTC License Setup Wizard](image/ctpAbb13.png) Fig.13 The KTC License Setup Wizard
...
![Image : : KTC License Management Password (License Key) ](image/ctpAbb14.png) Fig.14 KTC License Management Password (License Key)
...
![Image : Setup of the KTC License Management Extension ](image/ctpAbb15.png) Fig.15 Setup of the KTC License Management Extension
...
![Image : repeated setup of the KTC License Management App](image/ctpAbb16.png) Fig.16 repeated setup of the KTC License Management AppExtension
...
![Image : License overview](image/ctpAbb17.png) Fig.17 License overview
...
![Image : reset password (license key) ](image/ctpAbb18.png) Fig.18 reset password (license key)
...
![Image : Get new password (license key) ](image/ctpAbb19.png) Fig.19 Get new password (license key)
...
![Image : Manually check installed licenses ](image/ctpAbb20.png) Fig.20 Manually check installed licenses
...
![Image : Open the Microsoft Dynamics 365 Business Central Admin Portal](image/ctpAbb21.png) Fig.21 Open the Microsoft Dynamics 365 Business Central Admin Portal.
...
![Image : Selection of the environment in the Dynamics 365 Business Central Admin Center](image/ctpAbb22.png) Fig.22 Selection of the environment in the Dynamics 365 Business Central Admin Center
...
![Image : Calling up the extension management](image/ctpAbb23.png) Fig.23 Calling up the extension management
...
![Image : ContractPlus setup](image/ctpAbb24.png) Fig.24 ContractPlus setup

In the administration area of ContractPlus you can activate or deactivate the application in the current client. So you can define individually which clients can work with the ContractPlus extension.

![Image : Activate ContractPlus](image/ctpAbb25.png) Fig.25 Activate ContractPlus
...
![Image : Setup of the number series](image/ctpAbb26.png) Fig.26 Setup of the number series

![Image : Is the resubmission person or team oriented](image/ctpAbb27.png) Fig.27 Is the resubmission person or team oriented
...
![Image : Setting up the dimensions](image/ctpAbb28.png) Fig.28 Setting up the dimensions
...
![Image : Delete archived contracts](image/ctpAbb29.png) Fig.29 Delete archived contracts
...
![Image : Settle contracts](image/ctpAbb30.png) Fig.30 Settle contracts
...
![Image : Contract categories](image/ctpAbb31.png) Fig.31 Contract categories
...
![Image :Manage the dimensions](image/ctpAbb32.png) Fig.32 Manage the dimensions
...
![Image :the dimension "Contract Type](image/ctpAbb34.png) Fig.33 the dimension "Contract Type
...
![Image :Dimension values for contract types](image/ctpAbb35.png) Fig.34 Dimension values for contract types
...
![Image :Manage Contract Categories](image/ctpAbb36.png) Fig.35 Manage Contract Categories
...
![Image : ContractPlus "Tiles" in the Role Center](image/ctpAbb37.png) Fig.36 ContractPlus "Tiles" in the Role Center
...
![Image :Contract overview](image/ctpAbb38.png) Fig.37 : Contract overview
...
![Image :the "Contracts" tab in the overview](image/ctpAbb39.png) Fig.38 : The "Contracts" tab in the overview
...
In the Home tab, you will find management options for the selected contract. For example, you can renew the contract if the automatic renewal has not been activated. You can archive your entries, mark them for resubmission or restore archived contracts.

![Image :the "Home" tab in the overview](image/ctpAbb40.png) Fig.41 : the "Process" tab in the overview 
...
![Image :Master data of new contract](image/ctpAbb41.png) Fig.42 : Master data of the new contract
...
![Image :create the short contract](image/ctpAbb43.png) Fig.43 Create the short contract
...
![Image :Customize main contract](image/ctpAbb44.png) Fig.44 Customize main contract
...
![Image :Contract line main contract (I)](image/ctpAbb45.png) Fig.45 Contract line main contract (I)
...
![Image :Contract line main contract (II)](image/ctpAbb46.png) Fig.46 Contract line main contract (II)
...
![Image :Billing modalities and resubmission](image/ctpAbb47.png) Fig.47 Billing modalities and resubmission 
...
![Image :Responsibility and filing](image/ctpAbb48.png) Fig.48 Responsibility and filing 
...
![Image :Information and History](image/ctpAbb49.png) Fig.49 Information and History
...
![Image :the Infobox](image/ctpAbb50.png) Fig.49 the Infobox
...
![Image : Overview of settlements](image/ctpAbb53.png) Fig.50 Overview of settlements
