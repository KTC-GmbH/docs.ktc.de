...
![Image ContractPlus directly in MS AppSource, call via browser](../files/ctpAbb5.png) Fig.5 ContractPlus directly in MS AppSource, call via browser.
...
![Image :the "Home" tab in the overview](../files/ctpAbb40.png) Fig.41 : the "Process" tab in the overview 
